...
import static org.inesctec.flexcomm.fwd.OsgiPropertyConstants.IGNORE_IPV4_MCAST_PACKETS;
import static org.inesctec.flexcomm.fwd.OsgiPropertyConstants.IGNORE_IPV4_MCAST_PACKETS_DEFAULT;
...
import static org.inesctec.flexcomm.fwd.OsgiPropertyConstants.MATCH_DST_MAC_ONLY;
import static org.inesctec.flexcomm.fwd.OsgiPropertyConstants.MATCH_DST_MAC_ONLY_DEFAULT;
import static org.inesctec.flexcomm.fwd.OsgiPropertyConstants.MATCH_ICMP_FIELDS;
import static org.inesctec.flexcomm.fwd.OsgiPropertyConstants.MATCH_ICMP_FIELDS_DEFAULT;
import static org.inesctec.flexcomm.fwd.OsgiPropertyConstants.MATCH_IPV4_ADDRESS;
import static org.inesctec.flexcomm.fwd.OsgiPropertyConstants.MATCH_IPV4_ADDRESS_DEFAULT;
import static org.inesctec.flexcomm.fwd.OsgiPropertyConstants.MATCH_IPV4_DSCP;
import static org.inesctec.flexcomm.fwd.OsgiPropertyConstants.MATCH_IPV4_DSCP_DEFAULT;
import static org.inesctec.flexcomm.fwd.OsgiPropertyConstants.MATCH_IPV6_ADDRESS;
import static org.inesctec.flexcomm.fwd.OsgiPropertyConstants.MATCH_IPV6_ADDRESS_DEFAULT;
import static org.inesctec.flexcomm.fwd.OsgiPropertyConstants.MATCH_IPV6_FLOW_LABEL;
import static org.inesctec.flexcomm.fwd.OsgiPropertyConstants.MATCH_IPV6_FLOW_LABEL_DEFAULT;
import static org.inesctec.flexcomm.fwd.OsgiPropertyConstants.MATCH_TCP_UDP_PORTS;
import static org.inesctec.flexcomm.fwd.OsgiPropertyConstants.MATCH_TCP_UDP_PORTS_DEFAULT;
import static org.inesctec.flexcomm.fwd.OsgiPropertyConstants.MATCH_VLAN_ID;
import static org.inesctec.flexcomm.fwd.OsgiPropertyConstants.MATCH_VLAN_ID_DEFAULT;
...
import static org.inesctec.flexcomm.fwd.OsgiPropertyConstants.RECORD_METRICS;
import static org.inesctec.flexcomm.fwd.OsgiPropertyConstants.RECORD_METRICS_DEFAULT;
 ...
 */
@Component(immediate = true, service = ReactiveForwarding.class, property = {
...
public class ReactiveForwarding {
  ...
  private void readComponentConfiguration(ComponentContext context) {
    ...
    Boolean matchDstMacOnlyEnabled = Tools.isPropertyEnabled(properties, MATCH_DST_MAC_ONLY);
    ...
    Boolean matchVlanIdEnabled = Tools.isPropertyEnabled(properties, MATCH_VLAN_ID);
    ...
    Boolean matchIpv4AddressEnabled = Tools.isPropertyEnabled(properties, MATCH_IPV4_ADDRESS);
    ...
    Boolean matchIpv4DscpEnabled = Tools.isPropertyEnabled(properties, MATCH_IPV4_DSCP);
    ...
    Boolean matchIpv6AddressEnabled = Tools.isPropertyEnabled(properties, MATCH_IPV6_ADDRESS);
    ...
    Boolean matchIpv6FlowLabelEnabled = Tools.isPropertyEnabled(properties, MATCH_IPV6_FLOW_LABEL);
    ...
    Boolean matchTcpUdpPortsEnabled = Tools.isPropertyEnabled(properties, MATCH_TCP_UDP_PORTS);
    ...
    Boolean matchIcmpFieldsEnabled = Tools.isPropertyEnabled(properties, MATCH_ICMP_FIELDS);
    ...
    Boolean ignoreIpv4McastPacketsEnabled = Tools.isPropertyEnabled(properties, IGNORE_IPV4_MCAST_PACKETS);
    ...
    Boolean recordMetricsEnabled = Tools.isPropertyEnabled(properties, RECORD_METRICS);
  ...
  private class FlexWeigher implements LinkWeigher {
    ...
    public Weight weight(TopologyEdge edge) {
      ...
      double weight_src = calculateWeight(src);
      double weight_dst = calculateWeight(dst);

      return ScalarWeight.toWeight(weight_src + weight_dst + 1);
    }
